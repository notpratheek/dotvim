...
hi Cursor                                 ctermbg=none guibg=#ffaf00
hi CursorColumn                           ctermbg=none guibg=#444444
hi CursorLine                             ctermbg=none guibg=#3a3a3a cterm=none gui=none
hi Error        ctermfg=15  guifg=#ffffff ctermbg=89   guibg=#800000
hi ErrorMsg     ctermfg=87  guifg=#ffffff ctermbg=16   guibg=#800000 cterm=bold
hi FoldColumn   ctermfg=247 guifg=#9e9e9e ctermbg=233  guibg=#121212
hi Folded       ctermfg=255 guifg=#eeeeee ctermbg=60   guibg=#5f5f87
hi IncSearch    ctermfg=0   guifg=#000000 ctermbg=none guibg=#ffdfaf cterm=none gui=none
...
hi Pmenu        ctermfg=0   guifg=#000000 ctermbg=233 guibg=#bcbcbc
hi PmenuSel     ctermfg=2   guifg=#eeeeee ctermbg=233 guibg=#767676
hi PmenuSbar                              ctermbg=255 guibg=#d0d0d0
hi PmenuThumb   ctermfg=243 guifg=#767676
hi Search       ctermfg=0   guifg=#000000 ctermbg=none guibg=#afdf5f
...
hi StatusLine   ctermfg=15  guifg=#ffffff ctermbg=none guibg=#4e4e4e cterm=bold gui=bold
hi StatusLineNC ctermfg=249 guifg=#b2b2b2 ctermbg=none guibg=#3a3a3a cterm=none gui=none
hi TabLine      ctermfg=2   guifg=fg      ctermbg=237   guibg=#666666 cterm=bold gui=none
hi TabLineFill  ctermfg=fg  guifg=fg      ctermbg=240 guibg=#3a3a3a cterm=none gui=none
" FIXME
hi Title        ctermfg=225 guifg=#ffdfff ctermbg=89
...
hi Comment      ctermfg=253 guifg=#808080
...
""" vimdiff {{{3
hi diffAdd      ctermfg=none  guifg=bg      ctermbg=24 guibg=#afdfaf
"hi diffDelete   ctermfg=bg  guifg=bg      ctermbg=186 guibg=#dfdf87 cterm=none gui=none
hi diffDelete   ctermfg=none guifg=bg      ctermbg=none guibg=#949494 cterm=none gui=none
hi diffChange   ctermfg=none guifg=bg      ctermbg=none guibg=#dfafaf
hi diffText     ctermfg=none guifg=bg      ctermbg=102 guibg=#df8787 cterm=none gui=none
""" HTML {{{3
